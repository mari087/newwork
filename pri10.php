  ...
  <div id="ModalLoginForm" class="modal fade">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <h5 class="modal-title" id="exampleModalLabel">Add Extension Information</h5>
            ...
            <div class="modal-body">
                ...
                <form role="form" method="POST" action="addextensiondetails.php">
				...
				<?php 
                  $result = mysql_query("select * from departments ")or die(mysql_error());
                     ...
                     <div class="form-group">
                        ...
                        <div>
                            <input type="text" class="form-control input-lg" name="extension" value="" required>
                        </div>
                    </div>
