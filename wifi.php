  ...
  <div id="ModalLoginForm" class="modal fade">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <h5 class="modal-title" id="exampleModalLabel">Add Wifi Details</h5>
            ...
            <div class="modal-body">
                ...
                <form role="form" method="POST" action="addwifidetails.php">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        ...
        <div class="card-body">
         &nbsp;&nbsp;&nbsp; <button type="button" class="btn btn-primary btn-small" data-toggle="modal" data-target="#ModalLoginForm" ><i class="fa fa-plus-circle" aria-hidden="true"></span></i> Add Wifi Info
       </button><br/><br/>
          ...
          <div class="table-responsive">
            <table class="table table-condensed" id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody>
                <?php
                                                 include('dbcon.php');
                                                                $result= mysql_query("select *from wifidetails " ) or die (mysql_error());
                                                                while ($row= mysql_fetch_array ($result) ){
                                                                $id=$row['wifi_id'];
                                                                ?>
                <tr>
                                           ...
                                           <td><?php echo $row ['status']; ?></td>
                                            ...
                                            <a href="editwifidetails.php<?php echo '?id='.$id; ?>"> <font color="#424242"><i class="fa fa-pencil-square-o" aria-hidden="true" ></i></a>
                         ...
                         <a href data-toggle="modal"  data-target="#newviewmodal<?php echo $id; ?>"> <font color="#424242"><i class="fa fa-eye" aria-hidden="true" ></i></a>
                                           ...
                                           <?php include ('deletewifidetails.php');?> 
                                           <?php include ('viewwifidetails.php');?> 
