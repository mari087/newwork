  ...
  <div id="ModalLoginForm" class="modal fade">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <h5 class="modal-title"><b>Add NY Public IP Information</b></h5>
            ...
            <div class="modal-body">
                ...
                <form role="form" method="POST" action="addny-publicipdetails.php">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <input type="text" class="form-control input-lg" name="hostname" required>
                        </div>
                    </div>
                    <div class="form-group">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">NY-Public IP Information</li>
      </ol>
      ...
      <div class="card mb-3">
        ...
        <div class="card-body">
         &nbsp;&nbsp;&nbsp; <button type="button" class="btn btn-primary btn-small" data-toggle="modal" data-target="#ModalLoginForm" ><i class="fa fa-plus-circle" aria-hidden="true"></span></i> Add NY-Public IP Info
       </button><br/><br/>
          ...
          <div class="table-responsive">
            <table class="table table-condensed" id="dataTable" width="100%" cellspacing="0">
              <thead bgcolor="#eeeeee">
                <tr>
                  <th ><font color="#4d4d4d">Public IP Address</font></th>
                                            <th><font color="#4d4d4d">Local IP Address </font></th>
                                            <th><font color="#4d4d4d">Host Name</font></th>
                                            <th><font color="#4d4d4d">Description</font></th>
              ...
              <tbody>
                <?php
                                                 include('dbcon.php');
                                                                $result= mysql_query("select *from nypublicipdetails" ) or die (mysql_error());
                                                                while ($row= mysql_fetch_array ($result) ){
                                                                $id=$row['nypublicip_id'];
                                                                ?>
                <tr>
                         ...
                         <a href data-toggle="modal"  data-target="#deletemodal<?php echo $id; ?>"> <font color="#424242"><i class="fa fa-trash-o" aria-hidden="true" ></i></a>
                                           ...
                                           <?php include ('editny-publicipdetails.php');?> 
                                           <?php include ('deleteny-publicipdetails.php');?> 
