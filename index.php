<?php include('header.php'); ?>
  <body id="login">
	...
	<center><img src="amtexlogo2.png" class="img-polaroid"></center>
														...
														$.ajax({
															...
															success: function(html){
															 if (html == 'true_admin'){
																...
																$.jGrowl("Welcome o Amtex Systems", { header: 'Access Granted' });
															var delay = 1000;
																setTimeout(function(){ window.location = 'adminpage.php'  }, delay);  
															}else
															if (html == 'true_user'){
																$.jGrowl("Loading Please Wait......", { sticky: true });
																$.jGrowl("Welcome To Amtex Systems", { header: 'Access Granted' });
															var delay = 1000;
