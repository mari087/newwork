  ...
  <div id="ModalLoginForm" class="modal fade">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <h5 class="modal-title" id="exampleModalLabel">Add New Employee Email Information</h5>
            ...
            <div class="modal-body">
                ...
                <form role="form" method="POST" action="addnewemployeeemaildetails.php">
                    <input type="hidden" name="_token" value="">
                    <div class="form-group">
                        <label class="control-label">EMPID</label>
                        <div>
                            <input type="text" class="form-control input-lg" name="empid" value="">
                        </div>
                    </div>
                    <div class="form-group">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">New Employee Mail ID Details</li>
      </ol>
          ...
          <div class="table-responsive">
            <table class="table table-condensed" id="dataTable" width="100%" cellspacing="0">
              <thead bgcolor="#eeeeee">
                <tr>
                  <th><font color="#4d4d4d">EMPID</font></th>
              ...
              <tbody>
                <?php
                                                 include('dbcon.php');
                                                                $result= mysql_query("select *from newemployee_emaildetails" ) or die (mysql_error());
...
$row=mysql_fetch_array($query);
  ...
  ?>
            <div class="modal-body">
                ...
                <form role="form" class="form-horizontal" method="POST" action="update_newemployee_emaildetails.php">
                    <input type="hidden" name="_token" value="">
                    <div class="form-group">
                    <input type="hidden" class="form-control input-lg" name="emp_id" value="<?php echo $row['emp_id']; ?>">
                        <label class="control-label">EMPID:</label>
                        
                            <div ><input type="text" class="form-control input-lg" name="empid" value="<?php echo $row['empid']; ?>"></div>
